 ...
 *
 * Zero side effects, zero imports beyond types. These are the functions ported
 * verbatim into `src/detection/gesture/metrics.ts` at Phase 4 task P4.1, and
 * they are what the fixture suite tests against dumped landmark JSON.
 *
